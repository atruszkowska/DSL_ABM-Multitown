...
/// Series of tests for transitions of an exposed non-COVID hospital patient, with initialized COVID-19
bool test_exposed_transitions_seeded()
{
	// Time in days
	double dt = 0.25;
...
/// Series of tests for transitions of a symptomatic non-COVID hospital patient, with initialized COVID-19
bool test_symptomatic_transitions_seeded()
{
	// Time in days
	double dt = 0.25;
