...
int main()
{
	...
	// Input files
	std::string fin("input_data/Colonie_agents.txt");
	std::string hfile("input_data/Colonie_households.txt");
	std::string sfile("input_data/Colonie_schools.txt");
	std::string wfile("input_data/Colonie_workplaces.txt");
	std::string hsp_file("input_data/Colonie_hospitals.txt");
	std::string rh_file("input_data/Colonie_retirement_homes.txt");
	std::string cp_file("input_data/Colonie_carpool.txt");
	std::string pt_file("input_data/Colonie_public.txt");
	std::string ls_file("input_data/Colonie_leisure.txt");
	...
	abm.set_group_vaccination("hospital employees", true);
